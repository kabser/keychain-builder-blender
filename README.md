...
- Side ear with a round hole for the key ring — left or right side
...
6. Export via **File → Export → STL (.stl)** with **Selection Only** checked
...
| Hole Diameter (mm) | Key ring hole diameter. The hole is 2 mm from the outer edge. Recommended: 2–4 mm. |
...
- Боковое ушко с круглым отверстием под кольцо — слева или справа
...
6. Экспортируй через **File → Export → STL (.stl)** с включённым **Selection Only**
